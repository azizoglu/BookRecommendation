<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="KitapArama.aspx.cs" Inherits="KitapDegerlendirmeSistemi.business.KitapArama" %>
  ...
  <div class="container-fluid">
        <div class="row">
             <div class="col-lg-2 col-md-1">
                 <asp:TextBox ID="tbKitap" runat="server" CssClass="form-control" placeholder="Aranacak Yazar"></asp:TextBox> 
             </div>
